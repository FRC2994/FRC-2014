...
public class Gamepad extends Joystick {
	...
	// Axis Numbers
	public static final int AXIS_NUM_LEFT_X = 1;
	public static final int AXIS_NUM_LEFT_Y = 2;
	public static final int AXIS_NUM_RIGHT_X = 3;
	public static final int AXIS_NUM_RIGHT_Y = 4;
	public static final int AXIS_NUM_DPAD_X = 5;
	public static final int AXIS_NUM_DPAD_Y = 6;
	// Stick Button
    ...
    public int getDPad() {
        double x = getRawAxis(AXIS_NUM_DPAD_X);
        double y = getRawAxis(AXIS_NUM_DPAD_Y);
